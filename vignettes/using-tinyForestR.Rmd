...
```{r ndvi-images, eval=FALSE, cache=TRUE}

test <- calc_ndvi_buff(lon = -1.469, lat = 51.7779, dist1 = 1000, dist2 = 50, start_date = "2019-01-01", end_date = "2022-12-31", cloud_cover = 10, tf_id = 85)


test1 <- calc_ndvi_buff(lon = -1.469, lat = 51.7779, dist1 = 1000, dist2 = 50, start_date = "2017-01-01", end_date = "2018-12-31", cloud_cover = 10, tf_id = 85)
