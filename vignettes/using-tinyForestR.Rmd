...
Once the data is loaded we can save it as a csv file and get some high level information on planting, timings, size and so on. I have added the snapshot data to the `tinyForestR` package for consistency.

```{r tf-head}

tf_df <- tinyForestR::tf1
tf_df |>
  head()
